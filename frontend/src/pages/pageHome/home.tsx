            ...
            <div className="home-container">
                        ...
                        <>
                            <div className="home-product-list">
                                {currentProducts.map((item) => (
                                    <ProductCard key={item.productId} productId={item.productId} name={item.productName}
                                        price={item.price} image={item.imageUrl || "https://via.placeholder.com/150"}
                ...
                <div className="right-sidebar">
                    <div className="promo-box">
                        ...
                        <ul>
                            <li>
                                <FaGift className="icon" />Giảm 20% cho đơn từ 500K
                            </li>
                            <li>
                                <FaTruck className="icon" />Freeship toàn quốc
                            </li>
                            <li>
                                <FaMoneyBillWave className="icon" />Hoàn tiền 10%
                            </li>
                        </ul>
                    </div>
                    <div className="promo-box">
                        <h4 className="title-icon">
                            <FaStar className="icon star" />Gợi ý cho bạn
                        </h4>
